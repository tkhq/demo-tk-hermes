...
Read the root [result contract](../tk-cli/SKILL.md#machine-results-and-pending-work). Activity completion differs from transaction inclusion; this skill monitors Turnkey operations.
...
- Managing agent: operational recovery.
